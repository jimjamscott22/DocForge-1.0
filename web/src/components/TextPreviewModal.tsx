  ...
  return (
    <>
      ...
      <dialog
        ref={dialogRef}
        onClose={handleClose}
        className="fixed inset-0 z-50 m-auto h-[80vh] w-full max-w-3xl rounded-xl border border-stone-700/50 bg-stone-900 p-0 text-left text-stone-200 shadow-2xl backdrop:bg-black/60 backdrop:backdrop-blur-sm"
      >
        {/* Header */}
